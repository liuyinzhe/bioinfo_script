...
#curl -o SRR12345678.fastq.gz https://trace.ncbi.nlm.nih.gov/Traces/sra-reads-be/fastq?acc=SRR12345678
'''
拆分合并的fastq成read1 read2 文件
'''
...
input_name = sys.argv[1] # SRR12345678.fastq.gz
