...
NC2chr_dic = {}
with open('hg19.index',mode='rt',encoding='utf-8') as fh:
    for line in fh:
        if not  line.strip():
            continue
...
with gzip.open('GCF_000001405.25_GRCh37.p13_genomic.gtf.gz',mode='rt',encoding='utf-8') as fh, \
    open('gene_transcript.hg19.tsv',mode='wt',encoding='utf-8') as out:
