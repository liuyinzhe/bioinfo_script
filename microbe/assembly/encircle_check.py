...
import argparse
import pysam
# 修改自 https://github.com/bhattlab/lathe/blob/master/scripts/encircle.py
# 需要手动安装MUMmer 最新版 而不是conda安装的版本
fastaf = "genome.fasta"  # 仅支持1条序列的fasta
out = open("encircle.info", 'w') # 输出坐标
...
threads_int = 5
#align
print("Aligning...".format(t=str(threads_int)))
